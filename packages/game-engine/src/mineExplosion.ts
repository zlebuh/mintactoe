...
// on every field in the blast radius except the mine cell itself, mines included, for
// consistent counter bookkeeping even though a mine's own counter has no other effect.
